  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: Colors.white, // Consistent white like search container
        elevation: 0,
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Row(
                                children: _levels.map((level) {
                                  ...
                                  final levelColor = _getLevelFilterColor(
                                    level,
                                  );
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            gradient: LinearGradient(
                                              colors: [
                                                const Color.fromARGB(255, 193, 191, 191).withOpacity(0.95),
  ...
  Color _getLevelFilterColor(String level) {
    switch (level.toLowerCase()) {
      ...
      case 'advanced':
        return const Color(0xFFE57373); // Coral/Salmon Red
      case 'all':
        return const Color.fromARGB(255, 193, 191, 191).withOpacity(0.85); // Grey for "All"
      default:
        return const Color(0xFF9E9E9E); // Grey
    }
  }
